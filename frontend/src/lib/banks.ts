...
export const BRAZILIAN_BANKS: BankInfo[] = [
  // ─── Bancos populares ───
  // Todos já apontam para /banks/<id>.svg. Basta dropar o SVG oficial na pasta
  // frontend/public/banks/ e ele aparece automaticamente (fallback polido caso ausente).
  { id: 'nubank', name: 'Nubank', shortName: 'Nu', color: '#820AD1', textColor: '#FFFFFF', icon: 'Nu', logo: '/banks/nubank.svg' },
  { id: 'itau', name: 'Itau Unibanco', shortName: 'Itau', color: '#EC7000', textColor: '#FFFFFF', icon: 'Itaú', logo: '/banks/itau.svg' },
  { id: 'bradesco', name: 'Bradesco', shortName: 'Brad', color: '#CC092F', textColor: '#FFFFFF', icon: 'Brad', logo: '/banks/bradesco.svg' },
  { id: 'bb', name: 'Banco do Brasil', shortName: 'BB', color: '#FAE128', textColor: '#002D74', icon: 'BB', logo: '/banks/bb.svg' },
  { id: 'caixa', name: 'Caixa Economica', shortName: 'CEF', color: '#005CA9', textColor: '#FFFFFF', icon: 'CX', logo: '/banks/caixa.svg' },
  { id: 'santander', name: 'Santander', shortName: 'Sant', color: '#EC0000', textColor: '#FFFFFF', icon: 'San', logo: '/banks/santander.svg' },
  { id: 'inter', name: 'Banco Inter', shortName: 'Inter', color: '#FF7A00', textColor: '#FFFFFF', icon: 'Int', logo: '/banks/inter.svg' },
  { id: 'c6', name: 'C6 Bank', shortName: 'C6', color: '#1C1C1C', textColor: '#F5C96B', icon: 'C6', logo: '/banks/c6.svg' },
  ...
  { id: 'next', name: 'Next', shortName: 'Next', color: '#00E676', textColor: '#1A1A2E', icon: 'Nx', logo: '/banks/next.svg' },
  ...
  { id: 'pagbank', name: 'PagBank', shortName: 'Pag', color: '#00A650', textColor: '#FFFFFF', icon: 'Pag', logo: '/banks/pagbank.svg' },
  { id: 'will', name: 'Will Bank', shortName: 'Will', color: '#FFE600', textColor: '#1A1A2E', icon: 'Will', logo: '/banks/will.svg' },
  { id: 'sicoob', name: 'Sicoob', shortName: 'Sic', color: '#003B2D', textColor: '#FFFFFF', icon: 'Sic', logo: '/banks/sicoob.svg' },
  { id: 'sicredi', name: 'Sicredi', shortName: 'Sicr', color: '#008C3C', textColor: '#FFFFFF', icon: 'Scr', logo: '/banks/sicredi.svg' },
  { id: 'banrisul', name: 'Banrisul', shortName: 'Banr', color: '#003399', textColor: '#FFFFFF', icon: 'Bnr', logo: '/banks/banrisul.svg' },
  { id: 'original', name: 'Banco Original', shortName: 'Orig', color: '#00A651', textColor: '#FFFFFF', icon: 'Org', logo: '/banks/original.svg' },
  { id: 'safra', name: 'Banco Safra', shortName: 'Safra', color: '#003366', textColor: '#FFFFFF', icon: 'Sfr', logo: '/banks/safra.svg' },
  { id: 'pan', name: 'Banco Pan', shortName: 'Pan', color: '#00ADEF', textColor: '#FFFFFF', icon: 'Pan', logo: '/banks/pan.svg' },
  { id: 'bmg', name: 'Banco BMG', shortName: 'BMG', color: '#FF6600', textColor: '#FFFFFF', icon: 'BMG', logo: '/banks/bmg.svg' },
  { id: 'daycoval', name: 'Daycoval', shortName: 'Day', color: '#003366', textColor: '#FFFFFF', icon: 'Day', logo: '/banks/daycoval.svg' },
  { id: 'ame', name: 'Ame Digital', shortName: 'Ame', color: '#FF0066', textColor: '#FFFFFF', icon: 'Ame', logo: '/banks/ame.svg' },
  { id: 'stone', name: 'Stone', shortName: 'Stone', color: '#00A868', textColor: '#FFFFFF', icon: 'Stn', logo: '/banks/stone.svg' },
  { id: 'modal', name: 'Banco Modal', shortName: 'Modal', color: '#1A1A2E', textColor: '#FFFFFF', icon: 'Mdl', logo: '/banks/modal.svg' },
  { id: 'sofisa', name: 'Sofisa Direto', shortName: 'Sof', color: '#333333', textColor: '#FFFFFF', icon: 'Sof', logo: '/banks/sofisa.svg' },
  { id: 'agibank', name: 'Agibank', shortName: 'Agi', color: '#5B2D8E', textColor: '#FFFFFF', icon: 'Agi', logo: '/banks/agibank.svg' },
  { id: 'digio', name: 'Digio', shortName: 'Digio', color: '#003CFF', textColor: '#FFFFFF', icon: 'Dig', logo: '/banks/digio.svg' },
  { id: 'rico', name: 'Rico', shortName: 'Rico', color: '#FF5900', textColor: '#FFFFFF', icon: 'Rico', logo: '/banks/rico.svg' },
