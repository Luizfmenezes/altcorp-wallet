...
export const BRAZILIAN_BANKS: BankInfo[] = [
  ...
  { id: 'itau',         name: 'Itau Unibanco',        shortName: 'Itaú',   color: '#EC7000', textColor: '#FFFFFF', icon: 'Itaú', logo: '/banks/itau.svg' },
  ...
  { id: 'asaas',        name: 'Asaas',                shortName: 'Asaas',  color: '#0066FF', textColor: '#FFFFFF', icon: 'As',   logo: '/banks/asaas.svg' },
  ...
  { id: 'basa',         name: 'Banco da Amazônia',    shortName: 'BASA',   color: '#006400', textColor: '#FFFFFF', icon: 'BA',   logo: '/banks/basa.svg' },
  { id: 'beesbank',     name: 'Bees Bank',            shortName: 'Bees',   color: '#FFD100', textColor: '#1A1A2E', icon: 'Be',   logo: '/banks/beesbank.svg' },
  { id: 'bib',          name: 'Banco Industrial',     shortName: 'BIB',    color: '#003B71', textColor: '#FFFFFF', icon: 'BI',   logo: '/banks/bib.svg' },
  ...
  { id: 'bnb',          name: 'Banco do Nordeste',    shortName: 'BNB',    color: '#005799', textColor: '#FFFFFF', icon: 'BN',   logo: '/banks/bnb.svg' },
  ...
  { id: 'bs2',          name: 'Banco BS2',            shortName: 'BS2',    color: '#003B71', textColor: '#FFFFFF', icon: 'BS2',  logo: '/banks/bs2.svg' },
  ...
  { id: 'cora',         name: 'Cora',                 shortName: 'Cora',   color: '#FF4785', textColor: '#FFFFFF', icon: 'Co',   logo: '/banks/cora.svg' },
  ...
  { id: 'letsbank',     name: 'Lets Bank',            shortName: 'Lets',   color: '#1A1A2E', textColor: '#FFFFFF', icon: 'LB',   logo: '/banks/letsbank.svg' },
  ...
  { id: 'mercantil',    name: 'Banco Mercantil',      shortName: 'Merc',   color: '#003B71', textColor: '#FFFFFF', icon: 'Me',   logo: '/banks/mercantil.svg' },
